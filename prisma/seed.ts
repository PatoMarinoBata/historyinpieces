...
async function main() {
  ...
  const pieces = [
      ...
      },
      {
        ...
        images: ["https://images.unsplash.com/photo-1603386329225-868f9b1ee6b9?w=800"],
        category: "CAR",
      ...
      },
      {
        ...
        images: ["https://images.unsplash.com/photo-1553696563-d6d9e1a90986?w=800"],
        category: "DOCUMENT",
        transactionHistory: [
      ...
      },
      {
        ...
        images: ["https://images.unsplash.com/photo-1584208188493-2734248e3886?w=800"],
        category: "OTHER",
        transactionHistory: [
